...
export function Hero() {
  return (
    <section id="top" aria-label="Aura" className="relative overflow-hidden bg-ivory">
      ...
      <div className="pointer-events-none absolute inset-y-0 right-0 hidden lg:block lg:w-[47%] xl:w-[50%]">
        <img
      ...
      <Container className="relative pb-14 pt-14 sm:pt-20 lg:pb-28 lg:pt-24">
        <div className="max-w-xl lg:max-w-[470px] xl:max-w-[520px]">
          <p className="text-[13px] text-ink-soft">A personal diary for a fuller tomorrow</p>

          <h1 className="mt-5 display display-broken text-[clamp(2.05rem,4.1vw,2.9rem)] text-ink">
            Your life,
            <br />
          ...
          <a
            href="#remember"
            className="mt-9 inline-flex items-center gap-3 text-[14px] text-ink-soft hover:text-ink"
          >
